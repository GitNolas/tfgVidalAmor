 ...
 * @package  App\Console\Commands
 */
class ProbaScrapersXornada extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = "scraper:probaXornada";
    ...
    public function handle()
    {
        ...
        try {
          $output=exec("python3 ../tfgObtencionDatos/controlador.py -f -cC 9257086 -cG 9299485 -cF gal -cX 1");
